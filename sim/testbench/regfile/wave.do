...
add wave -noupdate -label s_wraddr -radix hexadecimal -radixshowbase 0 /regfile_tb/s_wraddr
add wave -noupdate -label s_wrdata -radix hexadecimal -radixshowbase 0 /regfile_tb/s_wrdata
add wave -noupdate -label s_regwrite /regfile_tb/s_regwrite
add wave -noupdate -label r_rddata1 -radix hexadecimal -radixshowbase 0 /regfile_tb/r_rddata1
add wave -noupdate -label r_rddata2 -radix hexadecimal -radixshowbase 0 /regfile_tb/r_rddata2
add wave -noupdate -label a_rddata1 -radix hexadecimal -radixshowbase 0 /regfile_tb/a_rddata1
